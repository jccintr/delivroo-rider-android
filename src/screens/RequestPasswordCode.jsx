  ...
  const handleSendCode = async () => {
        ...
        try {
            ...
            alert.show({
                ...
                message: 'Um código de verificação foi enviado para o seu e-mail. Verifique sua caixa de entrada.',
                onClose: () => {
                    navigation.navigate('verifyPasswordCode', { email });
                },
            });
           ...
           alert.show({
            ...
            message: err?.data?.error || err?.message || 'Erro ao enviar código de recuperação',
            });
        } finally {
            setIsLoading(false);
        }
